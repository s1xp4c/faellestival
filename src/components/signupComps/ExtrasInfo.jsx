    ...
    <section className="addOnSection">
      ...
      <div className="cardGrid">
        <AddOnCard>
          ...
          <CardTitle key={index} head={xtraData[0].title} className="addOnCardTitle" />
          <CardContent key={index} content={xtraData[0].content} />
          
          {guestQty % 2 == 0 && <AddOnCheckOut key={index}>
          {guestQty / 2} x 2 people tent (299kr.)</AddOnCheckOut>}
          {guestQty == 1 && <AddOnCheckOut key={index}>
          {guestQty} x 2 people tent (299kr.)</AddOnCheckOut>}
          {guestQty == 3 && <AddOnCheckOut key={index}>
          1 x 3 people tent (399kr.)</AddOnCheckOut>}
          {guestQty == 5 && <AddOnCheckOut key={index}>
          1 x 2 people tent (299kr.) <br></br>  1 x 3 people tent (399kr.) </AddOnCheckOut>}
       ...
       <Btn className="primBtn" action={addTentSet} >
        {tentSetAdded ? "Added" : `Add ${tentValue}kr.`}
           ...
           <AddOnCard key={index}> 
          <CardTitle key={index} head={xtraData[1].title} className="addOnCardTitle" />
...
{luxeAdded ? "Added" : `Add ${luxeValue}kr.`}
        ...
        <AddOnCard key={index}>
          <CardTitle key={index} head={xtraData[2].title} className="addOnCardTitle" />
