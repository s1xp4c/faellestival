    ...
    <div className="lineupGrid">
      {dayShort.map((day, index) => (
        ...
        <p className="lineupCardContent">
          {scheduleData.Jotunheim[day].map((day) => (day.act !== "break" && <Artist content={day.act} />))}
          {scheduleData.Vanaheim[day].map((day) => (day.act !== "break" && <Artist content={day.act} />))}
          {scheduleData.Midgard[day].map((day) => (day.act !== "break" && <Artist content={day.act} />))}
          </p>
        </div>))}
